...
#    Updated: 2023/01/15 00:46:52 by yel-mrab         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

CXX = c++
CXXFLAGS = -Wall -Wextra -Werror -std=c++98 -fsanitize=address -ggdb
INC = -Iinc/algorithme -Iinc/iterators -Iinc/vector -Iinc/type_traits -Iinc/pair -Iinc/stack -Iinc/redblacktree -Iinc/map
BUILD = build
OUT = containers

HEADERSFILES = iterators/base_iterator iterators/iterator_traits iterators/random_iterator iterators/reverse_iterator \
				vector/vector pair/pair stack/stack redblacktree/redblacktree map/map
